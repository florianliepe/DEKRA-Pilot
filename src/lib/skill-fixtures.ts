...
export const bootstrapSkillWorkspace: SkillWorkspace = {
  ...
  jobClarifications: [{ id: "CLAR-JD-DATA", jobDescriptionId: "JD-DATA", status: "in_progress", currentQuestion: 1, startedAt: "2026-08-06T09:55:00.000Z", updatedAt: "2026-08-06T10:00:00.000Z", idempotencyKey: "clarification-jd-data-v1", questions: [
    ...
    { id: "CLAR-JD-DATA-AUTONOMY", dimension: "autonomy", question: "Which reporting decisions can the analyst make independently?", rationale: "Autonomy is needed to calibrate proficiency.", status: "open" },
