...
export const bootstrapSkillWorkspace: SkillWorkspace = {
  ...
  mappings: [
    { id: "MAP-DV", jobDescriptionId: "JD-DATA", skillId: "SK-DV", targetLevel: 3, weight: 35, critical: true, relevance: 93, confidence: 92, rationale: "Dashboard creation and executive reporting require advanced visualisation capability.", evidence: ["Build interactive dashboards to report weekly revenue metrics."], evidenceRefs: ["SEG-JD-DATA-01"], strategicVectorIds: ["VEC-AI"], toolIds: ["TOOL-POWERBI"], scoreBreakdown: score({ semanticRelevance: 98, directEvidenceStrength: 98, responsibilityCoverage: 95, outcomeRelevance: 94, taxonomyCompatibility: 96, granularityCompatibility: 94, kflaCompatibility: 72, controlledToolRelevance: 98, proficiencyCompatibility: 92, approvedMappingSimilarity: 90 }), scoreVersion: "mapping-2.0.0", source: "agent", status: "approved", agentRunId: "RUN-001" },
    { id: "MAP-MC", jobDescriptionId: "JD-DATA", skillId: "SK-MC", targetLevel: 2, weight: 20, critical: true, relevance: 84, confidence: 83, rationale: "Explaining material performance movements requires structuring complex information.", evidence: ["Analyse performance drivers and explain material movements."], evidenceRefs: ["SEG-JD-DATA-02"], kflaCompetencyIds: ["KFLA-08"], strategicVectorIds: ["VEC-LEAD"], toolIds: [], scoreBreakdown: score({ semanticRelevance: 87, directEvidenceStrength: 86, responsibilityCoverage: 84, outcomeRelevance: 82, taxonomyCompatibility: 88, granularityCompatibility: 85, kflaCompatibility: 92, controlledToolRelevance: 40, proficiencyCompatibility: 78, approvedMappingSimilarity: 80 }), scoreVersion: "mapping-2.0.0", source: "agent", status: "proposed", agentRunId: "RUN-001" },
  ],
