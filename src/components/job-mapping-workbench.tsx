...
import { impactAnalysis, recalculateMapping, recordGovernedVersion } from "@/lib/skill-governance";
import { proficiencyLevels, type JobDescription, type JobSkillMapping, type MappingScoreBreakdown, type SkillWorkspace } from "@/lib/skill-schema";
...
function MappingRow({ mapping, workspace, mutate, onEdit }: { mapping: JobSkillMapping; workspace: SkillWorkspace; mutate: Props["mutate"]; onEdit: () => void }) {
