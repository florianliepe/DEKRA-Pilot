  ...
  return <div className="intake-view">
    ...
    <form className="intake-layout" onSubmit={(event) => {
      ...
      <aside className="intake-side">
        ...
        <p className="intake-note">The orchestrator returns a validated PMO document. Review the resulting view changes before publishing the next GitHub revision.</p>
      </aside>
    </form>
  </div>;
}
