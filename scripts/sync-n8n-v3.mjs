...
if (!node.parameters.jsCode.includes("jobClarifications:[]")) node.parameters.jsCode = node.parameters.jsCode.replace("interviews:[],elicitationSessions:[]", "interviews:[],jobClarifications:[],elicitationSessions:[]");
if (!node.parameters.jsCode.includes("mappingOmissions:[]")) node.parameters.jsCode = node.parameters.jsCode.replace("strategicVectors:(workspace.strategicVectors||[])", "mappingOmissions:[],strategicVectors:(workspace.strategicVectors||[])");
