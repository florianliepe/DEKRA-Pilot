...
5. Preserve n8n working-state and GitHub approved-release boundaries. This comparison makes no write or approval; use existing governed editors and human review for changes.
