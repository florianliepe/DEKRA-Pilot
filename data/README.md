...
- `agent-tool-registry.json` is a deny-by-default, fully expanded contract for the fifteen callable agent tools; it is separate from controlled business tools.
